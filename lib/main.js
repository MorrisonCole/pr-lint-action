...
exports.alreadyRequiredChanges = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        reviews.data.forEach((review) => {
            if (review.user != null &&
                ...
                (0, exports.alreadyRequiredChanges)(review.state)) {
...
const alreadyRequiredChanges = (state) => {
...
exports.alreadyRequiredChanges = alreadyRequiredChanges;
run().catch((error) => {
